...
const Contact = () => {
  ...
  return (
    <div className={`contact-container ${themeColor}`}>
      <div className="contact-info">
        <h3>{translations[language].contacth}</h3>
        <p>{translations[language].contactdesc}</p>
        <div className="social-icons">
          <a href="https://github.com/McTintor" target="_blank" rel="noopener noreferrer">
            <svg
          ...
          <a href="https://www.linkedin.com/in/tintor-igor" target="_blank" rel="noopener noreferrer">
